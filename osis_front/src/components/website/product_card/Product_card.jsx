  ...
  return (
    ...
    >
      <div
        ...
        style={{
          background: `url(.../../../../public/assets/images/product-img-7.jpg) no-repeat center`,
        }}
      >
        ...
        <div className="px-[30px] absolute left-0 top-3 w-full">
          <div className="progress-title flex justify-between ">
            ...
            <span className="text-sm text-qblack font-600 leading-6">20</span>
          </div>
          <div className="progress w-full h-[5px] rounded-[22px] bg-primarygray relative overflow-hidden">
            <div
              ...
              className="h-full absolute left-0 top-0 bg-qh3-blue"
            ></div>
          </div>
        </div>
        {/* product type  ${datas.product_type === "popular" ? "bg-[#19CC40]" : "bg-qyellow"}`} */}

        <div className="product-type absolute right-[14px] top-[17px]">
          <span className="text-[9px] font-700 leading-none py-[6px] px-3 uppercase text-white rounded-full tracking-wider ">
            popular
          </span>
        </div>
      </div>
      <div className="product-card-details px-[30px] pb-[30px] relative">
        ...
        <Link to="/single-product">
          <p className="title mb-2 text-[15px] font-600 text-qblack leading-[24px] line-clamp-2 hover:text-blue-600">
            iphone 16aaaaaaaaaaaaaaaaaaaaaaa
          </p>
        </Link>
        <p className="price">

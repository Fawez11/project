export const cartNotification = (cart, products, userName) => `<!DOCTYPE html>
<html lang="fr">
<head>
    <meta charset="UTF-8">
...
<body>
    <div class="container">
        ...
        <div class="order-info">
            ...
            <p><strong>ID Commande:</strong> ${cart.id}</p>
        ...
        <div class="footer">
            <p>Cette commande nécessite votre approbation dans le panneau d'administration.</p>

function LoginActivity() {
  ...
  return (
    <div className="tab-pane active" id="id4" role="tabpanel">
      <form action="#">
          ...
          >
            <thead className="sherah-table__head">
              <tr>
                ...
                <th className="sherah-table__column-2 sherah-table__h2">IP</th>
              ...
              <tr>
                ...
                <td className="sherah-table__column-3 sherah-table__data-3">
                  <div className="sherah-table__product-content">
                    <p className="sherah-table__product-desc">
                      Mar 24, 2022{" "}
                      <span className="sherah-table__time">04:26 PM</span>
                    </p>
                  </div>
                </td>

    ...
    <div className="sherah-dsinner">
      <div className="row mg-top-30">
        <div className="col-12 sherah-flex-between">
          ...
          <div className="sherah-breadcrumb">
            <h2 className="sherah-breadcrumb__title">Vendors</h2>
      ...
      <div className="sharah-profile--main sherah-default-bg sharah-border mg-top-40">
        ...
        <div className="sherah-userprofile__header">
          <img src="img/profile-cover.jpg" alt="#" />
          <div className="sherah-userprofile__right">
            <a href="#" className="sherah-btn sherah-btn__white">
              <svg
          ...
          <div className="sherah-profile-info">
            ...
            <div className="sherah-profile-info__follow">
              <div className="sherah-profile-info__list">
                <span className="sherah-profile-info__title">Followers</span>
                <h4 className="sherah-profile-info__number">5410</h4>
              </div>
              <div className="sherah-profile-info__list">
                <span className="sherah-profile-info__title">Following</span>
                <h4 className="sherah-profile-info__number">1250</h4>
              </div>
            </div>
          </div>
          {/* <!-- End Profile Info --> */}
                ...
                <div className="tab-content" id="nav-tabContent">
                  ...
                  >
                    <div className="sherah-upcontent__text sherah-border">
                      ...
                      <div className="sherah-border-btm mg-top-30"></div>
                      <div className="row">
